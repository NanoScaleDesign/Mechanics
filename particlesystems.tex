...
\subsection*{Solutions}
(a) \hash{a}{300026} \SI{}{\kg\per\second} \\
(b) \hash{b}{a2fb8f} \SI{}{\kg\per\second}
...
\iffalse
\newpage
\section{Chain style sample problem I}
...
\newpage
\section{Chain style sample problem II}
...
\newpage
\section{Chain style sample problem difference}
...
\subsection*{Challenge}
Why was the kinetic energy different in the two sample problems? How might the kinetic energy change if the rope in sample problem 4/10 was made of a combination of small loops like the chain in sample problem 4/9?

\subsection*{Solution}
Please compare your thoughts with your partner.
\fi
